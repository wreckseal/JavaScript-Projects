...
function get_todos() {
    // This creates an array of the task that are inputted
    var todos = new Array;
...
// This function adds the inputted task to the get_todos function
function add() {
...
function show() {
    ...
    // This tells the display how to display the todo array after an item has been removed
...
// This creates a functionality of removing a todo item from the array
function remove() {
