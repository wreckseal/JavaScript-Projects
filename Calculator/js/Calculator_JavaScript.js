...
// This modifies values each time a button is clicked on the calculator
function Input_Digit(digit) {
    const { Display_Value, Wait_Second_Operand } = Calculator;
    // This checks if the Wait_Second_Operand is true and sets Display_Value to the key that was clicked on the calculator
...
function Input_Decimal(dot) {
    ...
    // If the Display_Value does not contain a decimal point, add one
...
function Handle_Operator(Next_Operator) {
    ...
    // When an operator key is pressed, convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand if it doesn't already exist
    ...
    if (First_Operand == null) {
        ...
        // Here we add a fixed amount of numbers after the decimal to avoid floating point issues
...
// This object contains the calculations used in the calculator
...
// This function resets the calculator back to its original state
